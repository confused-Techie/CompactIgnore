...
beforeAll(() => {
  ...
  files.docker = fs.readFileSync(
    path.resolve("./tests/spec/integration/.dockerignore"),
    { encoding: "utf8" }
  );
  files.eslint = fs.readFileSync(
    path.resolve("./tests/spec/integration/.eslintignore"),
    { encoding: "utf8" }
  );
  files.git = fs.readFileSync(
    path.resolve("./tests/spec/integration/.gitignore"),
    { encoding: "utf8" }
  );
  files.npm = fs.readFileSync(
    path.resolve("./tests/spec/integration/.npmignore"),
    { encoding: "utf8" }
  );
  files.prettier = fs.readFileSync(
    path.resolve("./tests/spec/integration/.prettierignore"),
    { encoding: "utf8" }
  );
  files.gcloud = fs.readFileSync(
    path.resolve("./tests/spec/integration/.gcloudignore"),
    { encoding: "utf8" }
  );
...
describe("Ignore files generate the expected data", () => {
  ...
  test(".eslintignore is correct", () => {
    const expected =
      "# === Autogenerated by CompactIgnore::eslintignore === #\n\n" +
      "# An Orphan Comment to appear at the top of each file\n" +
      "/node/modules\n" +
      "!/keep/this\n";
  ...
  test(".gitignore is correct", () => {
    const expected =
      "# === Autogenerated by CompactIgnore::gitignore === #\n\n" +
      "# An Orphan Comment to appear at the top of each file\n" +
      "/node/modules\n" +
      "!/keep/this\n";
  ...
  test(".npmignore is correct", () => {
    const expected =
      "# === Autogenerated by CompactIgnore::npmignore === #\n\n" +
      "# An Orphan Comment to appear at the top of each file\n" +
      "/node/modules\n" +
      "!/keep/this\n" +
      "/only/for/npm\n";
  ...
  test(".gcloudignore is correct", () => {
    const expected =
      ...
      "!/keep/this\n" +
      "/only/for/gcloud\n" +
      "!/ignore/only/for/gcloud\n";

    expect(files.gcloud).toBe(expected);
  });
});
...
afterAll(() => {
  ...
  fs.rmSync(path.resolve("./tests/spec/integration/.gcloudignore"));
});
